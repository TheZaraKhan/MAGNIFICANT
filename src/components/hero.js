    ...
    <section className=" ">
      ...
      >
        ...
        >
          ...
          />
          <div
            className="carousel-item absolute bg-neutral opacity-0"
            style={{ height: "100vh" }}
          >
            <div className="block bg-hero1  h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right">
          ...
          <div
            ...
            style={{ height: "100vh" }}
          >
            <div className="block bg-hero2 h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right">
              <div className="content w-1/2 mx-32">
                {/*  add any content in this box  */}
          ...
          <div
            ...
            style={{ height: "100vh" }}
          >
            <div className="block bg-hero3 h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-center">
              <div className="content w-1/2 mx-32">
                {/*  add any content in this box  */}
